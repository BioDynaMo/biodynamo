...
#pragma link C++ class bdm::SoPointer<bdm::neuroscience::NeuriteExt<bdm::CompileTimeParam<bdm::Soa>, bdm::neuroscience::Capsule<bdm::neuroscience::NeuriteExt>, bdm::SimulationObject>, bdm::Soa>+;
#pragma link C++ class bdm::SoPointer<bdm::neuroscience::NeuronExt<bdm::CompileTimeParam<bdm::Soa>, bdm::neuroscience::Capsule<bdm::neuroscience::NeuronExt>, bdm::Cell_TCTParam_TDerived>, bdm::Soa>+;
#pragma link C++ class bdm::neuroscience::NeuronNeuriteAdapter<bdm::SoPointer<bdm::neuroscience::NeuronExt<bdm::CompileTimeParam<bdm::Soa>, bdm::neuroscience::Capsule<bdm::neuroscience::NeuronExt>, bdm::Cell_TCTParam_TDerived>, bdm::Soa>, bdm::SoPointer<bdm::neuroscience::NeuriteExt<bdm::CompileTimeParam<bdm::Soa>, bdm::neuroscience::Capsule<bdm::neuroscience::NeuriteExt>, bdm::SimulationObject>, bdm::Soa> >+;
