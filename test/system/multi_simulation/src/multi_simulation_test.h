...
inline int Simulate(int argc, const char** argv, TimeSeries* result,
  ...
  result->Add("param1", {0}, {static_cast<real>(sparam->param1)});
  result->Add("param2", {0}, {static_cast<real>(sparam->param2)});
  result->Add("param3", {0}, {static_cast<real>(sparam->param3)});
