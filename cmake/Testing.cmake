...
function(bdm_add_test_executable TEST_TARGET)
  ...
  if (valgrind AND NOT coverage
    ...
    add_test(NAME "valgrind_${TEST_TARGET}" COMMAND ${CMAKE_SOURCE_DIR}/util/valgrind.sh ./${TEST_TARGET} -- --gtest_filter=-*DeathTest.*:IOTest.InvalidRead:SchedulerTest.Backup:ResourceManagerTest.SortAndApplyOnAllElementsParallel*:InlineVector*:NeuriteElementTest.RetractAllDendrites)
  endif()
