...
# <REFLEX> is for enabling rootcling's reflex mode. In this mode the LinkDef needs to be an XML Selection
#   file.
#---------------------------------------------------------------------------------------------------
...
#        "${library_target_name} mismatch. Deduction stem: ${dictionary}.")
  ...
  add_custom_command(OUTPUT ${dictionary}.cc ${pcm_name} ${rootmap_name} ${cpp_module_file}
    COMMAND ${LAUNCHER} ${command} -v2 -f  ${dictionary}.cc ${newargs} ${excludepathsargs} ${rootmapargs}
                                        ${ARG_OPTIONS}
