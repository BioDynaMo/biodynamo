...
# biodynamo gui
install(FILES build/${GUI_BIN_NAME} DESTINATION ${CMAKE_INSTALL_BINDIR}
        PERMISSIONS OWNER_READ OWNER_EXECUTE GROUP_READ GROUP_EXECUTE WORLD_READ WORLD_EXECUTE)
install(FILES build/${GUI_BIN_NAME}_dict_rdict.pcm DESTINATION ${CMAKE_INSTALL_BINDIR})
install(DIRECTORY ${GUI_ICONS} DESTINATION ${CMAKE_INSTALL_BINDIR})
# bdm-config
...
#   third party headers
install(DIRECTORY ${EXTRACTED_THIRD_PARTY_LIBS}/morton DESTINATION ${CMAKE_INSTALL_INCLUDEDIR} FILES_MATCHING PATTERN "*")
install(DIRECTORY ${EXTRACTED_THIRD_PARTY_LIBS}/mpark DESTINATION ${CMAKE_INSTALL_INCLUDEDIR} FILES_MATCHING PATTERN "*")
