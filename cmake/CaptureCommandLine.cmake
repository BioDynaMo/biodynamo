...
if(NOT WIN32)
  ...
  set(RECMAKE_REPLAY_TMP_FILE ${CMAKE_BINARY_DIR}/tmp/recmake_replay.sh)
  set(RECMAKE_INITIAL_TMP_FILE ${CMAKE_BINARY_DIR}/tmp/recmake_initial.sh)
  ...
  if (NOT EXISTS ${RECMAKE_INITIAL_FILE})
      FILE(WRITE ${RECMAKE_INITIAL_TMP_FILE} "#!/bin/sh\n"
           "rm -f CMakeCache.txt\n"
           "${CMAKE_INVOKE} ${RECMAKE_GENERATOR}\n")
      FILE(COPY ${RECMAKE_INITIAL_TMP_FILE} DESTINATION ${CMAKE_BINARY_DIR}
           FILE_PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ GROUP_EXECUTE WORLD_READ WORLD_EXECUTE)
  endif()
  if (EXISTS ${RECMAKE_REPLAY_FILE})
    FILE(APPEND ${RECMAKE_REPLAY_FILE} "${CMAKE_INVOKE}\n")
  else()
    FILE(WRITE ${RECMAKE_REPLAY_TMP_FILE} "#!/bin/sh\n"
         "rm -f CMakeCache.txt\n"
         "${CMAKE_INVOKE} ${RECMAKE_GENERATOR}\n")
    FILE(COPY ${RECMAKE_REPLAY_TMP_FILE} DESTINATION ${CMAKE_BINARY_DIR}
         FILE_PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ GROUP_EXECUTE WORLD_READ WORLD_EXECUTE)
  endif()
