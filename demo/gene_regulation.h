...
inline int Simulate(int argc, const char** argv) {
  ...
  // The first is of type  std::function<float(float, float)>.
  // This is the function by which concentration of the protein will be
  // calculated.
  // The second is float. This is the initial value for the protein.
  ...
  const std::vector<std::array<float, 3>>& positions = {{0, 0, 0}};
