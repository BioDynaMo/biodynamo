...
inline int Simulate(int argc, const char** argv) {
  ...
  // auto ne = neuron.ExtendNewNeurite(2.0, Math::kPi / 4.0, Math::kPi /
  // 2.0).Get();  // FIXME theta and phi are mixed up in the function
  auto ne = neuron
                .ExtendNewNeurite(2.0, DegreesToRadians(36.6992),
                                  DegreesToRadians(63.4349))
                .Get();  // FIXME theta and phi are mixed up in the function
