...
public class TetrahedronFactory<T> {
    ...
    private static final boolean NATIVE = simulation.useNativeTetrahedron;
    public static final boolean DEBUG = simulation.debugTetrahedron;
    ...
    public Tetrahedron create(Triangle3D<T> oneTriangle, SpaceNode<T> fourthPoint,
        ...
        if (NATIVE) {
            return  ini.cx3d.swig.simulation.TetrahedronT_PhysicalNode.create(oneTriangle, fourthPoint, oto);
        } else if (!DEBUG){
    ...
    public Tetrahedron create(Triangle3D<T> triangleA, Triangle3D<T> triangleB,
                              ...
                              SpaceNode<T> nodeD) {
        if (NATIVE) {
            return ini.cx3d.swig.simulation.TetrahedronT_PhysicalNode.create(triangleA, triangleB, triangleC, triangleD, nodeA, nodeB, nodeC, nodeD);
        } else if (!DEBUG){
    ...
    public static <T> Tetrahedron createInitialTetrahedron(SpaceNode a,
        ...
        if (NATIVE) {
            result = ini.cx3d.swig.simulation.TetrahedronT_PhysicalNode.createInitialTetrahedron(a, b, c, d, oto);
        } else {
    ...
    public static int getEdgeNumber(int nodeNumber1, int nodeNumber2) {
        int result = 0;
        if (NATIVE) {
            result = ini.cx3d.swig.simulation.TetrahedronT_PhysicalNode.getEdgeNumber(nodeNumber1, nodeNumber2);
        } else {
    ...
    public static <T> Tetrahedron[] remove2FlatTetrahedra(
        ...
        Tetrahedron[] result = null;
        if (NATIVE) {
            AbstractSequentialList<Tetrahedron> list = ini.cx3d.swig.simulation.TetrahedronT_PhysicalNode.remove2FlatTetrahedra(tetrahedronA, tetrahedronB);
    ...
    public static <T> Tetrahedron[] flip2to3(Tetrahedron tetrahedronA,
        ...
        Tetrahedron[] result = null;
        if (NATIVE) {
            result = ini.cx3d.swig.simulation.TetrahedronT_PhysicalNode.flip2to3(tetrahedronA, tetrahedronB);
        } else {
    ...
    public static <T> Tetrahedron[] flip3to2(Tetrahedron tetrahedronA,
        ...
        Tetrahedron[] result = null;
        if (NATIVE) {
            result = ini.cx3d.swig.simulation.TetrahedronT_PhysicalNode.flip3to2(tetrahedronA, tetrahedronB, tetrahedronC);
        } else {
