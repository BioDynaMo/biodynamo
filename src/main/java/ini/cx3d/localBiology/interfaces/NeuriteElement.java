 ...
 */
public interface NeuriteElement extends CellElement {
	/** Note : doesn't copy the <code>LocalBiologyModule</code> list
	 * (this is done in <code>branch()</code> etc.).*/
	ini.cx3d.localBiology.interfaces.NeuriteElement getCopy();
	 ...
	 * @param direction
	 */
	void elongateTerminalEnd(double speed, double[] direction);
	 ...
	 * @return
	 */
	NeuriteElement branch(double newBranchDiameter, double[] growthDirection);
	 ...
	 * @return
	 */
	NeuriteElement branch(double[] growthDirection);
	 ...
	 * @return
	 */
	NeuriteElement[] bifurcate(double[] direction_1, double[] direction_2);
	 ...
	 * Makes a single spine (the physical and the biological part) randomly on this NeuriteElement.
	 */
	void makeSingleSpine(double distFromProximalEnd);
	 ...
	 */
	void makeSingleBouton(double distFromProximalEnd);
	 ...
	 * @return
	 */
	int synapseBetweenExistingBS(double probabilityToSynapse);
	...
	PhysicalCylinder getPhysicalCylinder();

	void setPhysicalCylinder(PhysicalCylinder physicalcylinder);
	 ...
	 */
	NeuriteElement getDaughterLeft();
	 ...
	 */
	NeuriteElement getDaughterRight();
	 ...
	 * @return
	 */
	AbstractSequentialList<NeuriteElement> addYourselfAndDistalNeuriteElements(AbstractSequentialList<NeuriteElement> elements);
}
