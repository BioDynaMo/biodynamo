...
%define %TriangleHashKey_ported_type_modification()
  %ported_type_modification(cx3d::spatial_organization::TriangleHashKey<cx3d::PhysicalNode>,
                            ini.cx3d.spatialOrganization.interfaces.TriangleHashKey<ini.cx3d.physics.PhysicalNode>);
%enddef

%define %TriangleHashKey_ported_add_equals()
  %ported_add_equals(cx3d::spatial_organization::TriangleHashKey<cx3d::PhysicalNode>,
