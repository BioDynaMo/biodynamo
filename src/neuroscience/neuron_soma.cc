...
//
// virtual NeuronSoma::~NeuronSoma() {}
//
// explicit NeuronSoma::NeuronSoma(const std::array<double, 3>& position) : Base(position) {}
//
// void NeuronSoma::EventConstructor(const Event& event, SimObject* mother_so, uint64_t new_oid = 0) override {
//
...
// }
//
// void NeuronSoma::EventHandler(const Event& event, SimObject *other1, SimObject* other2 = nullptr) override {
...
// }
//
// void NeuronSoma::RemoveDaughter(const SoPointer<NeuriteElement>& daughter) override {
...
// }
//
// std::array<double, 3> NeuronSoma::OriginOf(SoUid daughter_uid) const override {
...
// }
//
// void NeuronSoma::UpdateDependentPhysicalVariables() override {}
//
