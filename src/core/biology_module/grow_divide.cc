...
GrowDivide::GrowDivide(const Event& event, BaseBiologyModule* other,
                       uint64_t new_oid)
...
BaseBiologyModule* GrowDivide::GetInstance(const Event& event,
...
void GrowDivide::EventHandler(const Event& event, BaseBiologyModule* other1,
