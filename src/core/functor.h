...
///
///     void PrintSmallNeighbors(Agent* agent, real threshold) {
///       auto functor = L2F([&](Agent* neighbor, real squared_distance)) {
...
///
///     class MyFunctor : public Functor<void, Agent*, real> {
///      public:
///       MyFunctor(real threshold) : threshold_(threshold) {}
///       virtual ~MyFunctor() {}
