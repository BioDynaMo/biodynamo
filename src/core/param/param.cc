...
void Param::AssignFromConfig(const std::shared_ptr<cpptoml::table>& config) {
  ...
  BDM_ASSIGN_CONFIG_VALUE(souid_defragmentation_low_watermark_, "performance.souid_defragmentation_low_watermark");
  BDM_ASSIGN_CONFIG_VALUE(souid_defragmentation_high_watermark_, "performance.souid_defragmentation_high_watermark");
