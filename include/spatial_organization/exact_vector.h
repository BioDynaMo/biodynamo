...
class ExactVector : public std::enable_shared_from_this<ExactVector> {
 public:
   ...
   */
  std::shared_ptr<Rational> squaredLength() const;
   ...
   * @return A new instance of <code>ExactVector</code>.
   */
  std::shared_ptr<ExactVector> multiply(const std::shared_ptr<Rational>& factor);
   ...
   * @return A reference to <code>this</code>, which has been modified.
   */
  std::shared_ptr<ExactVector> multiplyBy(const std::shared_ptr<Rational>& factor);
   ...
   * @return A new instance of <code>ExactVector</code>.
   */
  std::shared_ptr<ExactVector> divide(const std::shared_ptr<Rational>& factor);
   ...
   * @return A reference to <code>this</code>, which has been modified.
   */
  std::shared_ptr<ExactVector> divideBy(const std::shared_ptr<Rational>& factor);
   ...
   */
  std::shared_ptr<Rational> dotProduct(const std::shared_ptr<ExactVector>& other);
